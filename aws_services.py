...
class AwsServices:
    ...
    def publish_elb_ip_count_metric(self, ip_dict):
        ...
        try:
            ...
            logger.exception(
                f"Failed to put data to CloudWatch metric. Error: {e}")
    ...
    def download_elb_ip_from_s3(self, object_key):
        ...
        try:
            ...
            logger.error(
                ...
                f"It is normal for the first time when the Lambda is triggered. Error: {e}"
            )
    ...
    def get_ip_target_list_by_target_group_arn(self, tg_arn):
        ...
        try:
            ...
            logger.exception(
                f"Failed to get target list from target group - {tg_arn}")
